...
local UiLib = loadstring(game:HttpGet("https://raw.githubusercontent.com/NightScripts-API/Polar/main/library.lua"))()
...
local Actyrn_7104 = UiLib:CreateWindow("Negative | Private | v1 | badovh | cz", Vector2.new(500, 600), Enum.KeyCode.RightShift)
...
local v1beta = BetaTab:CreateSector("Client", "left")
local v2beta = BetaTab:CreateSector("V2 Beta", "right")
...
TargetStrafeSec:AddSlider("Speed", 0.5, 0.5, 30, 2, function(Value)
	TargetStrafe.Speed = Value
end)

TargetStrafeSec:AddSlider("Distance", 0.001, 1, 20, 2, function(Value)
...
MovementSec:AddSlider("Speed Amount", 1, 1, 1000000, 1, function(Value)
...
MovementSec:AddSlider("Flight Amount", 1, 1, 750000, 1, function(Value)
